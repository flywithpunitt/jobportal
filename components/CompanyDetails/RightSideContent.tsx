...
const RightSideContent = () => {
  ...
  const [isGallery, setisGallery] = useState<any>(false);
  ...
  return (
    <React.Fragment>
      {isGallery ? (
        <Lightbox
          mainSrc={images[photoIndex] as any}
          nextSrc={images[(photoIndex + 1)   % images.length] as any}
          prevSrc={images[(photoIndex + images.length - 1) % images.length] as any}
          enableZoom={true}
          onCloseRequest={() => {
            setisGallery(false);
          }}
        ...
        <Card className="ms-lg-4 mt-4 mt-lg-0">
          <CardBody className="p-4">
            ...
            <div>
              ...
              {jobVacancyPost.map((jobVacancyPostDetails:any, key:number) => (
                <div
                  key={key}
                  className={
